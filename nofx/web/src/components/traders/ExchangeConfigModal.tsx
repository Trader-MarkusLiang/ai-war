...
const SUPPORTED_EXCHANGE_TEMPLATES = [
  ...
  { exchange_type: 'weex', name: 'WEEX', type: 'cex' as const },
...
export function ExchangeConfigModal({
  ...
  const exchangeRegistrationLinks: Record<string, { url: string; hasReferral?: boolean }> = {
    ...
    weex: { url: 'https://www.weex.com', hasReferral: false },
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="px-6 pb-6">
          ...
          >
            ...
            {selectedTemplate && (
              <>
                {/* Binance/Bybit/OKX/Bitget/WEEX 的输入字段 */}
                {(currentExchangeType === 'binance' ||
                  ...
                  currentExchangeType === 'weex') && (
                    <>
                      ...
                      {(currentExchangeType === 'okx' || currentExchangeType === 'bitget' || currentExchangeType === 'weex') && (
                        <div>
                          <label
                            className="block text-sm font-semibold mb-2"
                            style={{ color: '#EAECEF' }}
