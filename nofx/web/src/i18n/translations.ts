...
export const translations = {
  en: {
    ...
    customDisplayName: 'Display Name (Optional)',
    customDisplayNamePlaceholder: 'e.g.: Claude AI - 1, DeepSeek Main',
    customDisplayNameHint: 'Custom name to identify this model instance',
  ...
  zh: {
    ...
    customDisplayName: '显示名称 (可选)',
    customDisplayNamePlaceholder: '例如: Claude AI - 1, DeepSeek 主账号',
    customDisplayNameHint: '自定义名称以区分同一供应商的不同模型实例',
    saveConfig: '保存配置',
    editExchange: '编辑交易所',
    addExchange: '添加交易所',
